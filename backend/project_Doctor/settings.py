"""
Django settings for project_Doctor project.
...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-5%c!^&#1lp5%1ko68j&u))r520vsi^*h!#6lb#&!%rtxp)lc%t")
...
ROOT_URLCONF = 'project_Doctor.urls'
...
WSGI_APPLICATION = 'project_Doctor.wsgi.application'
